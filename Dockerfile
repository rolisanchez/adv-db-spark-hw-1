# Modified for a Homework on Advanced Databases
# Based on Getty Images "https://github.com/gettyimages/docker-spark"
FROM debian:jessie
MAINTAINER  Victor R. Sanchez J. "roli.s91@gmail.com"
...
RUN apt-get update \
 ...
 && apt-get install -y python python-tk idle python-pmw python-imaging \
 && apt-get clean \
 && rm -rf /var/lib/apt/lists/*
...
#ADDITIONAL COMMANDS TO RUN PYTHON SCRIPTS
RUN echo 'export SPARK_HOME=/usr/spark-2.0.2' >> ~/.bashrc 
